...
export default function About() {
  ...
  return (
    <Bounded className="relative py-8 md:py-12">
      <div className="flex flex-col items-center justify-between lg:flex-row lg:gap-8">
        ...
        <div className="mx-auto mb-12 max-w-2xl text-left md:mb-16 lg:w-1/2">
          <TextGenerateEffect words="Discover the powerhouse behind innovative engineering, construction, and consultancy solutions. The K&K Group brings together three dynamic companies, each excelling in its specialized domain. Explore our companies below to find the right fit for your needs." />
        </div>
